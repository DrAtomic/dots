...
;; leo: modified whitespace tabs and spaces
...
;;;;; whitespace-mode
   ...
   `(whitespace-tab ((t (:background ,zenburn-bg :foreground ,zenburn-bg+1))))
   `(whitespace-newline ((t (:background ,zenburn-bg+2 :foreground ,zenburn-red+2))))
